...
public class Game {
    ...
    JLabel titleNameLabel, hpLabel, hpLabelNumber, wpLabel, weaponLabelName;
    ...
    public Game() {
        ...
        startButton.setFocusPainted(false); // Removes the inner border from the button.
    ...
    public void east() {
        position = "east";
        mainTextArea.setText("You walked into a forest and found a weapon.\n\n(You obtained a Long Sword)");
        weapon = "Long Sword";
        weaponLabelName.setText(weapon);
    ...
    public void playerAttack() {
        ...
        weaponStrength = (weapon.equals("Long Sword")) ? 8 : 3;
        
        playerDamage = new java.util.Random().nextInt(weaponStrength);
    ...
    public void monsterAttack() {
        ...
        mainTextArea.setText("The monster attacked and you received " + monsterDamage + " damage!");
